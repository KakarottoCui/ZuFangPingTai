...
<div class="wrapper" style="width: 900px;margin-top: 40px">
    ...
    <form id="updateHouse" class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="houseExamine" lay-verify="required">
                    <option value=""></option>
                    <option value="审核通过"<c:if test="${House.houseExamine == '审核通过'}"> selected</c:if>>审核通过</option>
                    <option value="审核未通过"<c:if test="${House.houseExamine == '审核未通过'}"> selected</c:if>>审核未通过</option>
                </select>
            </div>
        </div>
